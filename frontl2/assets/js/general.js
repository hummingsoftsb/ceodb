$(document).ready(function(){
	...
	var json = [ 
		...
		{"chart_title":"SYS 205","chart_id":"db_donut_5","chart_value":"50","set_donut":"2","url":"#"},
		{"chart_title":"SYS 206","chart_id":"db_donut_6","chart_value":"85","set_donut":"2","url":"#"},
		{"chart_title":"SYS 207","chart_id":"db_donut_7","chart_value":"17","set_donut":"2","url":"#"}
	];
	for (i = 0; i < json.length; i++) {
		var b = json[i];
