<div id="float_plate" class="row">
	...
	<div id="plate_legend">
		...
		<div id="pl_label_content">
			<span class="set1">No Data</span>
			<span class="set2">On Schedule</span>
			<span class="set3">Behind Late</span>
			<span class="set4">Critical</span>
			<span class="set5">Depot</span>
			<span class="set6">Station</span>
			<span class="set7">Track</span>
		</div>
	</div>
	<div id="plate_issue">
		<div id="pi_title">
	...
	<div id="plate_label">
		...
		<div id="pl_station">
			<span class="set1">Sungai Buloh</span>
			...
			<span class="set10">Kampung Batu</span>
			<span class="set11">Kentonmen</span>
			<span class="set12">Jalan Ipoh</span>
			<span class="set13">Sentul West</span>
			<span class="set14">Titiwangsa</span>
			<span class="set15">Hospital Kuala Lumpur</span>
			<span class="set16">Kampung Baru North</span>
			<span class="set17">Ampang Park</span>
			<span class="set18">KLCC East</span>
			<span class="set19">Conley</span>
			<span class="set20">Tun Razak Exchange</span>
			<span class="set21">Chan Sow Lin</span>
			<span class="set22">Bandar Malaysia North</span>
			<span class="set23">Bandar Malaysia South</span>
			<span class="set24">Kuchai Lama</span>
			<span class="set25">Taman Naga Emas</span>
			<span class="set26">Sungai Besi</span>
			<span class="set27">Technology Park</span>
			...
			<span class="set32">Taman Universiti</span>
			<span class="set33">Equine Park</span>
			<span class="set34">Taman Putra Permai</span>
