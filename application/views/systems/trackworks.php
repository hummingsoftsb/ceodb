			...
			<div id="navbar-left">
			 ...
			 <div id="navbar">
                 <div class="fim-dropdown">
				    <a class="nav-img-container" href="#"><img src="<?php echo $this->config->base_url(); ?>assets/img/nav_intallation.png" /><i class="fa fa-arrow-up" style="color: rgb(13, 139, 43)"></i><br><span class="pull-left" style="color: #f3b308; font-size: 13px; font-weight:600;">100%</span></a>
                     <div class="inner">
                         <table id="nav_drop">
                             <thead>
                             <tr>
				...
				<a class="nav-img-container" href="<?php echo $this->config->base_url(); ?>sbk-s-06/index"><img src="<?php echo $this->config->base_url(); ?>assets/img/systems/tw/manufacturing.png" /><i class="fa fa-arrow-down" style="color: rgb(243, 179, 8)"></i><br><span class="pull-left" style="color: #f3b308; font-size: 13px; font-weight:600;">96.8%</span></a>
			</div> 
...
<!--	</div>-->
	...
	<div style="position:absolute; z-index:2; top: 520px;left: 29px;">
		<a href="<?php echo $this->config->base_url(); ?>r2/index" class="pkg_title">KD9A</a>
	</div>
	<div style="position:absolute; z-index:2; top: 610px;left: 85px;">
		<a href="<?php echo $this->config->base_url(); ?>r3/index" class="pkg_title">KD9</a>
	</div>
	<div style="position: absolute; z-index: 2; top: 610px; left: 230px;">
		<a href="<?php echo $this->config->base_url(); ?>r4/index" class="pkg_title">KD10</a>
	</div>	
	<div style="position: absolute; z-index: 2; top: 520px; left: 435px;">
		<a href="<?php echo $this->config->base_url(); ?>r5/index" class="pkg_title">KD11</a>
	</div>
	<div style="position: absolute; z-index: 2; top: 400px; left: 530px;">
		<a href="<?php echo $this->config->base_url(); ?>r6/index" class="pkg_title">KD11A</a>
	</div>
	<div style="position: absolute; z-index: 2; top: 306px; left: 605px;">
		<a href="<?php echo $this->config->base_url(); ?>r7/index" class="pkg_title">KD12</a>
	</div>
    <div style="position: absolute; z-index: 2; top: 364px; left: 735px;">
        <a href="<?php echo $this->config->base_url(); ?>r4/index" class="pkg_title">KD13</a>
    </div>
    <div style="position: absolute; z-index: 2; top: 420px; left: 884px;">
        <a href="<?php echo $this->config->base_url(); ?>r5/index" class="pkg_title">KD14</a>
    </div>
    <div style="position: absolute; z-index: 2; top: 522px; left: 1054px;">
        <a href="<?php echo $this->config->base_url(); ?>r6/index" class="pkg_title">KD15</a>
    </div>
    <div style="position: absolute; z-index: 2; top: 585px; left: 1202px;">
        <a href="<?php echo $this->config->base_url(); ?>r7/index" class="pkg_title">KD16</a>
    </div>
