...
mpxd.modules.train_manufacturing_progress_table.train_progress = Backbone.View.extend({
    ...
    render: function() {
		...
		$.when.apply($, promises).then(function(a) {
			...
			var kjdnumber = getNumberOfTrains(trainData['kjd']);
			...
			var renderManufacturing = function(data) {
				...
				var $table = generateTable([
					...
					["29", "04/12/15", "<div style='width:100%; height: 10px; background:red; display: inline-block'></div>"],
					["30", "11/12/15", "<div style='width:100%; height: 10px; background:red; display: inline-block'></div>"],
					["31", "18/12/15", "<div style='width:100%; height: 10px; background:red; display: inline-block'></div>"],
					["32", "25/12/15", "<div style='width:100%; height: 10px; background:grey; display: inline-block'></div>"],
					["33", "02/01/16", "<div style='width:100%; height: 10px; background:grey; display: inline-block'></div>"],
					["34", "08/01/16", "<div style='width:100%; height: 10px; background:grey; display: inline-block'></div>"],
					["35", "15/01/16", "<div style='width:100%; height: 10px; background:grey; display: inline-block'></div>"],
					["36", "22/01/16", "<div style='width:100%; height: 10px; background:grey; display: inline-block'></div>"]
				]);
